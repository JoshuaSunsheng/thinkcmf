...
var mapGeoData = new Object();
mapGeoData.params = new Object()

console.log(mapGeoData)
for (var cc in cityMap) {
    mapType.push(cc);
    // 自定义扩展图表类型
    mapGeoData.params[cc] = {
        getGeoJson: (function (c) {
            var geoJsonName = cityMap[c];
            return function (callback) {
                console.log(geoJsonName);
                $.getJSON(DATA_URL + 'map/' + geoJsonName + '.json', callback);
            }
        })(cc)
    }
}

var callback = function (chinaJson) {
...
//
//$.getJSON('{$DATA_URL}map/110100.json', function (data) {
