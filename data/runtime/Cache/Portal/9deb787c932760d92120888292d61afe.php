<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
	...
	<style>
		...
		<link href="/themes/simplehpx/Public/assets/css/slippry/slippry.css" rel="stylesheet">
		<style>
				...
				<div class="header">
					<div class="item-image">
						<a href="<?php echo leuu('article/index',array('id'=>$vo['object_id'],'cid'=>$vo['term_id']));?>">
							<?php if(empty($smeta['thumb'])): ?><img src="/themes/simplehpx/Public/assets/images/default_tupian1.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
							<?php else: ?>
...
<!-- Le javascript
    ...
    <script src="/themes/simplehpx/Public/assets/simpleboot/bootstrap/js/bootstrap.min.js"></script>
...
//		$("#think_page_trace_open").css('display','none');
	</script>


<script src="/themes/simplehpx/Public/assets/js/slippry.min.js"></script>
<script>
$(function() {
